...
const Profile = () => {
  ...
  // Initialize userData from auth context
  ...
  // Load user data from context when component mounts or user changes
  useEffect(() => {
    if (user) {
      const initialData = {
        name: user.name || "",
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
          {/* Cover Image */}
          <div className="h-32 bg-gradient-to-r from-[#B7410E] to-[#D7490C]"></div>
                ...
                <div className="relative">
                  <div className="w-32 h-32 rounded-full border-4 border-white bg-gray-200 flex items-center justify-center overflow-hidden">
                    {userData.avatar ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-r from-[#B7410E] to-[#D7490C] flex items-center justify-center text-white text-4xl font-bold">
                        {userData.name ? (
                  ...
                  {isEditing && (
                    <>
                      ...
                      <button
                        ...
                        disabled={isLoading}
                        className="absolute bottom-0 right-0 bg-[#D7490C] text-white p-2 rounded-full hover:bg-[#B7410E] transition-colors disabled:opacity-50"
                      >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 border border-gray-300 rounded-lg ${isEditing
                        ? "focus:ring-2 focus:ring-[#D7490C] focus:border-transparent"
                        : "bg-gray-50"
                        }`}
                    />
                  </div>
                    ...
                    >
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#D7490C] focus:border-transparent ${passwordErrors.currentPassword
                            ? "border-red-500"
                            : "border-gray-300"
                            }`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handlePasswordChange}
                          className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#D7490C] focus:border-transparent ${passwordErrors.newPassword
                            ? "border-red-500"
                            : "border-gray-300"
                            }`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handlePasswordChange}
                          className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#D7490C] focus:border-transparent ${passwordErrors.confirmPassword
                            ? "border-red-500"
                            : "border-gray-300"
                            }`}
